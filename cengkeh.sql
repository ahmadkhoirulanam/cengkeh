...
('3453211', 'adminpusat', 'Rt', 'Anshori', '1992-06-09', 'Pati', 'Laki-Laki', '', 'Pati', '', 'Kerja', NULL, NULL, 'adminpusat'),
...
--
-- Table structure for table `pemalang`
--

CREATE TABLE `pemalang` (
  `id` int(3) NOT NULL,
  `kecamatan` varchar(255) NOT NULL,
  `tanah` int(5) NOT NULL,
  `produksi` int(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `pemalang`
--

INSERT INTO `pemalang` (`id`, `kecamatan`, `tanah`, `produksi`) VALUES
(1, 'Mega', 712, 657),
(2, 'Warungpring', 78, 28),
(3, 'pulosari', 725, 221),
(4, 'belik', 844, 357),
(5, 'watukumpul', 1034, 485),
(6, 'bodeh', 13, 4),
(7, 'bantarbolang', 8, 2),
(8, 'radudongkal', 165, 44),
(9, 'pemalang', 0, 0),
(10, 'taman', 0, 0),
(11, 'petarukan', 0, 0),
(12, 'ampelgading', 0, 0),
...
--
-- Indexes for table `pemalang`
--
ALTER TABLE `pemalang`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `pemalang`
--
ALTER TABLE `pemalang`
