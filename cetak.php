...
<body>
    ...
    if (isset($_GET['id'])) {
        $id = $_GET['id'];
        $query = "SELECT * FROM data_request_sktm natural join data_user WHERE id_request_sktm=$id";
...
<div class = "rangkasurat">
     ...
     <table border="0" align="center">
        <tr>
            <td>
                <center>
                    <font size="4"><b>SURAT KETERANGAN TIDAK MAMPU / MISKIN</b></font><br>
                    <hr style="margin:0px" color="black">
                    <font size="3"><b>Nomor : 045.2 / <?php echo $id; ?> / VIII / 2023</b></font><br>
                </center>
            </td>
        </tr>
    </table>
    ...
    <table border="0" align="">
        <tr>
            <td>
            <font size="4">Yang bertanda tangan di bawah ini Kepala Desa Kedumulyo Kecamatan Sukolilo, Menerangkan bahwa : </font>
            </td>
        </tr>
    </table>
    <br>
    ...
    <br>
    <div class="body">
        <p><font size="4">Warga tersebut diatas adalah benar penduduk desa Kedumulyo Kecamtan Sukolilo Kabupaten Pati yang bertempat tinggal di alamat tersebut diatas.</font></p>
        <p><font size="4">Surat keterangan tidak mampu ini kami berikan atas permintaan yang bersangkutan untuk <?php echo $data['keperluan']; ?> atas nama <?php echo $data['nama']; ?></font></p>
