...
<?php
    ...
    if (isset($_GET['id'])) {
        $id = $_GET['id'];
        $query = "SELECT * FROM data_request_skd natural join data_user WHERE id_request_skd=$id";
...
<div class = "rangkasurat">
        ...
        <tr>
            <td>
                <center>
                    ...
                    <font size="3"><b>Nomor : <?php echo $id; ?> / SKU-KDM / VIII / 2023</b></font><br>
                </center>
            </td>
        </tr>
    </table>
    ...
    <br>
    <div class="body">
        <p><font size="4">Berdasarkan pengamatan kami, orang tersebut diatas benar-benar penduduk yang berdomisili di Desa Kedumulyo Kecamatan Sukolilo Kabupaten Pati dan terdaftar dalam registrasi kependudukan kami dengan NIK  <?php echo $data['nik']; ?>.</font></p>
