...
<div class = "rangkasurat">
    ...
    <br>
    <div class="body">
        <p><font size="4">Orang tersebut adalah benar penduduk Desa Kami yang berdomisili di alamat diatas serta berdasarkan pengamatan kami bahwa orang tersebut diatas adalah benar mempunyai usaha <?php echo $data['usaha']; ?>. Adapun Surat Keterangan usaha ini dibuat sebagai persyatan <?php echo $data['keperluan']; ?> </font></p>
