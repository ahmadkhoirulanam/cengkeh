					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Lengkapi Biodata Anda, sebelum Mengajukan Permohonan Surat</h5>
							</div>
					...
					<div class="row mt-5">
						<div class="col-md-3 pr-md-0">
								<div class="card-pricing2 card-primary">
									<div class="pricing-header">
										<h2 class="fw-bold text-center text-uppercase">SKTM</h2>
									</div>
									...
									<div class="price-value">
										<div class="value">
											...
											<span class="amount"><i class="fas fa-plus-circle"></i><span></span></span>
						...
						<div class="col-md-3 pr-md-0">
								<div class="card-pricing2 card-success">
									<div class="pricing-header">
									<h2 class="fw-bold text-center text-uppercase">SKU</h2>
									</div>
									<div class="price-value">
										<div class="value">
											<span class="currency"></span>
						...
						<div class="col-md-3 pr-md-0">
								<div class="card-pricing2 card-warning">
									<div class="pricing-header">
									<h2 class="fw-bold text-center text-uppercase">SKP</h2>
									</div>
									<div class="price-value">
										<div class="value">
											<span class="currency"></span>
						...
						<div class="col-md-3 pr-md-0">
								<div class="card-pricing2 card-secondary">
									<div class="pricing-header">
									<h2 class="fw-bold text-center text-uppercase">SKD</h2>
									</div>
									<div class="price-value">
										<div class="value">
											<span class="currency"></span>
