            ...
            <div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Daftar Pesebaran Cengkeh</h2>
							</div>
						</div>
					</div>
                </div>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<!-- <div class="card-tools">
											<a href="?halaman=tambah_administrasi" target="_blank" class="btn btn-info btn-border btn-round btn-sm">
								...
								<div class="card-body">
									<table class="table mt-3">
										...
										<tbody>
											...
											<tr>
												<td><?php echo $no; ?></td>
												<td style="width: 20%"><?php echo $row['kecamatan']; ?></td>
												<td><?php echo substr($row['tanah'], 0, 20); ?></td>
												<td><?php echo $row['produksi']; ?></td>												
												
												<td>
													<div class="form-button-action">
														<a href="?halaman=ubah_administrasi&id=<?php echo $row['id']; ?>" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit User">
															<i class="fa fa-edit"></i>
														</a>
														<a href="?halaman=hapus_administrasi&id=<?php echo $row['id_administrasi']; ?>" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Hapus User">
