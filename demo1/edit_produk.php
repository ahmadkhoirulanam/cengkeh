  ...
  <body>
      ...
      <section class="base">
        ...
        <div>
         ...
         <input type="text" name="deskripsi" value="<?php echo $data['keterangan']; ?>" />
        </div>
        <div>
          <label>Harga Beli</label>
         <input type="text" name="id_jenis_administrasi" required=""value="<?php echo $data['id_jenis_administrasi']; ?>" />
        </div>
        <div>
