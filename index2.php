...
<head>
    ...
    <title>Pelayanan Surat Keterangan Online DESA SEMBUNGHARJO</title>
    <!-- core CSS -->
...
<body id="home" class="homepage">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll"><a href="pegawai.php">Login Admin</a></li>
                    </ul>
                </div>
            </div>
            <!--/.container-->
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms"><span>PELAYANAN</span> SURAT KETERANGAN <br> DESA SEMBUNGHARJO</h2>
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                ...
                                <p>Permohonan di setujui oleh lurah, kemudian Rt akan mencetak surat sesuai request surat yang diajukan, pemohon mengambil surat yang sudah dicetak dan bertandatangan di Kantor DESA SEMBUNGHARJO.</p>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; <?php echo date('Y');?> KANTOR DESA SEMBUNGHARJO
                </div>
                <div class="col-sm-6">
