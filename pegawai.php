        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <center><h2>LOGIN PEGAWAI</h2></center>
              <!-- <h4>LOGIN PEGAWAI</h4> -->
              <form method="POST" class="pt-3">
              <div class="form-group">
                  <input type="text" name="hak_akses" class="form-control form-control-xs text-uppercase" placeholder="UserName" required autofocus>
                </div>
                <div class="form-group">
